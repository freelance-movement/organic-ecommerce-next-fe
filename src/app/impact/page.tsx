            ...
            <section className="py-16 md:py-24 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-lg text-gray-600" data-testid="text-stats-subtitle">
            ...
            <section className="py-16 md:py-24 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-lg text-gray-600" data-testid="text-stories-subtitle">
            ...
            <section className="py-16 md:py-24 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-lg text-gray-600" data-testid="text-culture-subtitle">
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <div className="space-y-6 text-lg text-gray-300">
                        ...
                        <p data-testid="text-why-matters-p2">
                            ...
                            traditions, and promoting sustainable agriculture. You're part of a
                            story that connects Vietnamese soil to your table, carrying with it
                            generations of knowledge and care.
                        </p>
                        <p data-testid="text-why-matters-p3">
                            Together, we're proving that commerce can be a force for good, creating
                            prosperity while protecting our planet and honoring our cultural
                            heritage.
                        </p>
                    </div>
                </div>
