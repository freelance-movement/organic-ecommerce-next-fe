                        ...
                        <div>
                            ...
                            <div className="space-y-4 text-lg text-gray-700">
                                <p data-testid="text-story-paragraph-1">
                                    ...
                                    agricultural regions. Our founders, deeply connected to the land
                                    and its traditions, witnessed the incredible quality of organic
                                    products grown by local farmers.
                                </p>
                                <p data-testid="text-story-paragraph-2">
                                    We saw an opportunity to bridge the gap between these dedicated
                                    farmers and conscious consumers around the world. Our mission
                                    became clear: to create a sustainable platform that honors
                                    Vietnamese agricultural heritage while meeting the growing
                                    global demand for authentic, organic products.
                                </p>
                                <p data-testid="text-story-paragraph-3">
                                    Today, VietRoot stands as a testament to the power of community,
                                    quality, and cultural authenticity. Every product we offer tells
                                    a story of Vietnamese craftsmanship and natural excellence.
                                </p>
                            </div>
                        </div>
                        <div>
            ...
            <section className="py-16 md:py-24 bg-viet-earth-cream">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <div className="bg-white rounded-xl p-8 md:p-12 shadow-lg">
                        ...
                        >
                            "Growing up in rural Vietnam, I learned that the best products come from
                            the heart. Every farmer we partner with shares our commitment to quality
                            and sustainability. VietRoot is more than a business – it's our way of
                            sharing Vietnam's natural treasures with the world while ensuring our
                            farmers receive fair compensation for their dedication."
                        </blockquote>
                        <p
            ...
            <section className="py-16 md:py-24 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-lg text-gray-600" data-testid="text-timeline-subtitle">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="text-center p-6 bg-white rounded-xl shadow-lg">
                            ...
                            <p className="text-gray-600">
                                Preserving and sharing the rich agricultural traditions of Vietnam.
                            </p>
                        </div>
                    </div>
                </div>
