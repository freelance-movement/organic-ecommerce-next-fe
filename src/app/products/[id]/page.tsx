...
import { Star, Heart, ShoppingCart, Truck, Shield, Award, ArrowLeft, ChevronRight, Plus, Minus, Share2, CheckCircle, Leaf, MessageCircle } from "lucide-react";
...
const getProductById = (id: string) => {
  const products: Record<string, any> = {
    "1": {
      ...
      usage: "Take 1-2 tablespoons daily on empty stomach or dissolve in warm water. Can be used as natural sweetener in teas and beverages.",
      storage: "Store in cool, dry place away from direct sunlight. Crystallization is natural and indicates purity.",
      certifications: ["Organic Certified", "HACCP Compliant", "Quality Tested"],
      farmer: {
        name: "Nguyen Van Duc",
        location: "Ha Giang",
        experience: "25 years",
        story: "Third generation beekeeper maintaining traditional harvesting methods"
      }
    },
    "2": {
      id: 2,
      ...
      usage: "Steep 1 teaspoon in 80°C water for 2-3 minutes. Can be re-steeped 2-3 times.",
      storage: "Store in airtight container away from light, heat, and moisture.",
      ...
      <section className="py-6 bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <Link href="/products" className="hover:text-viet-green-dark transition-colors">
              Products
            </Link>
            <ChevronRight className="h-4 w-4" />
            ...
            <div className="space-y-8">
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  {product.badges.map((badge: string, index: number) => (
                    <Badge key={index} variant="secondary" className="bg-viet-green-light text-viet-green-dark">
                      {badge}
                    </Badge>
                  ))}
                </div>
                
                <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4" data-testid="text-product-name">
                  {product.name}
                </h1>
              ...
              <div className="bg-gradient-to-r from-viet-green-light to-viet-earth-light p-6 rounded-2xl">
                <div className="flex items-center gap-4">
                  <span className="text-4xl font-bold text-viet-green-dark" data-testid="text-product-price">
                    {product.price}
                  </span>
                ...
                <p className="text-viet-green-dark mt-2">Free shipping on orders over ₫500,000</p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Tabs defaultValue="description" className="w-full">
            <TabsList className="grid w-full grid-cols-4 bg-gray-100 p-1 rounded-xl">
              ...
              <TabsTrigger value="farmer" className="rounded-lg">Our Farmer</TabsTrigger>
            ...
            <div className="mt-12">
                  ...
                  <div className="grid md:grid-cols-2 gap-8 mt-8">
                    <div className="bg-viet-green-light/30 p-6 rounded-xl">
                      ...
                      <ul className="space-y-2 text-gray-700">
                        ...
                        <li><strong>Harvest Date:</strong> {product.harvestDate}</li>
              ...
              <TabsContent value="benefits" className="space-y-6">
                ...
                <div className="grid gap-4">
                  {product.benefits.map((benefit: string, index: number) => (
                    <div key={index} className="flex items-start gap-3 p-4 bg-viet-green-light/20 rounded-xl">
                ...
                <div className="bg-gradient-to-r from-viet-green-light to-viet-earth-light p-8 rounded-2xl mt-8">
                  <h4 className="font-bold text-xl text-viet-green-dark mb-4">How to Use</h4>
                  <p className="text-gray-700 text-lg leading-relaxed">{product.usage}</p>
                </div>
              </TabsContent>
              ...
              <TabsContent value="farmer" className="space-y-6">
                <div className="bg-gradient-to-r from-viet-green-dark to-viet-green-medium text-white p-8 rounded-2xl">
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    <div>
                      <h4 className="text-xl font-semibold mb-2">{product.farmer.name}</h4>
                      <p className="text-viet-green-light mb-1">{product.farmer.location}</p>
                      <p className="text-viet-green-light mb-4">{product.farmer.experience} of experience</p>
                      <p className="text-lg leading-relaxed">{product.farmer.story}</p>
                    </div>
              ...
              <TabsContent value="reviews" className="space-y-6">
                ...
                <div className="bg-gray-50 p-8 rounded-2xl">
                  <div className="grid md:grid-cols-2 gap-8">
                    <div className="text-center">
                      <div className="text-5xl font-bold text-viet-green-dark mb-2">{product.rating}</div>
                      <div className="flex justify-center gap-1 mb-2">
                        {[...Array(5)].map((_, i) => (
                          <Star key={i} className={`h-6 w-6 ${i < Math.floor(product.rating) ? 'text-yellow-400 fill-current' : 'text-gray-300'}`} />
                        ))}
                      </div>
                  ...
                  {[
                    {
                      ...
                      rating: 5,
                      date: "March 20, 2024",
                      comment: "Absolutely amazing honey! The flavor is so pure and rich. You can really taste the difference from regular store-bought honey. Will definitely order again."
                    },
                    {
                      name: "David Chen",
                      rating: 5,
                      date: "March 15, 2024",
                      comment: "Best quality honey I've ever had. Perfect for my morning tea routine. Fast shipping and excellent packaging too."
                    },
                    {
                      name: "Maria Santos",
                      rating: 4,
                      date: "March 10, 2024",
                      comment: "Great product, love the natural taste. Only wish the packaging was a bit larger for the price, but the quality is definitely worth it."
                    }
                  ].map((review, index) => (
            ...
            {relatedProducts.map((relatedProduct) => (
              <Link key={relatedProduct.id} href={`/products/${relatedProduct.id}`}>
                <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 overflow-hidden">
                  ...
                  <div className="p-6">
                    <h3 className="font-semibold text-lg text-gray-900 mb-2">{relatedProduct.name}</h3>
                    <div className="flex items-center justify-between">
                      <span className="text-2xl font-bold text-viet-green-dark">{relatedProduct.price}</span>
                      <div className="flex items-center gap-1">
