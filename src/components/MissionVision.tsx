            ...
            <div className="space-y-8 animate-fade-in-up animation-delay-400">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
                ...
                <p className="text-lg leading-relaxed text-white/90 mb-6">
                  ...
                  farmers while delivering premium organic products that tell
                  the story of our beautiful homeland.
                </p>
                <p className="text-lg leading-relaxed text-white/90">
                  Every product we offer carries the essence of Vietnamese soil,
                  the dedication of our farmers, and our unwavering commitment
                  to preserving traditional farming methods for future
                  generations.
                </p>
              </div>
            </div>
              ...
              <div className="bg-gradient-to-br from-white to-viet-earth-cream rounded-3xl p-8 shadow-2xl border border-viet-green-light/20 relative overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
                    <p>
                      We envision a future where Vietnamese organic products are
                      recognized worldwide as symbols of quality, authenticity,
                      and sustainable agriculture.
                    </p>
                    <p>
                      Through innovation and tradition, we will create a global
                      network that honors our farmers, protects our environment,
                      and nourishes communities across continents.
                    </p>
