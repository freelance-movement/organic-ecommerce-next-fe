...
const products = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1553279030-83ba509d4d48?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300",
  ...
  },
  {
    ...
    price: "₫250,000",
    image:
      "https://images.unsplash.com/photo-1526318472351-c75fcf070305?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300",
...
export default function FeaturedProducts() {
  ...
  return (
    <section className="py-16 md:py-16 bg-[#e6f5dc] relative overflow-hidden">
