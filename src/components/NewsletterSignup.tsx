...
export default function NewsletterSignup() {
    ...
    return (
        <section className="py-16 md:py-16 bg-gradient-to-br from-viet-green-dark via-viet-green-medium to-viet-green-dark text-white relative overflow-hidden">
            ...
            <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    ...
                    >
                        Be the first to discover new products, get exclusive offers, and hear
                        inspiring stories from our farming communities across Vietnam.
                    </p>
                </div>
                    ...
                    <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 md:p-12 border border-white/20 shadow-2xl animate-fade-in-up animation-delay-400">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <p className="text-center text-white/70 text-sm">
                                📧 Get weekly updates • 🎁 Exclusive discounts • 📖 Farmer stories •
                                🌱 Sustainability tips
                            </p>
                        </form>
                    </div>
