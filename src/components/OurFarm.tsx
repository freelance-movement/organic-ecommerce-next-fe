...
const farmVideos = [
    {
        ...
        videoUrl: 'https://player.vimeo.com/video/176916362?background=1&autoplay=1&loop=1&muted=1',
        thumbnail:
    ...
    },
    {
        ...
        videoUrl: 'https://player.vimeo.com/video/347119375?background=1&autoplay=1&loop=1&muted=1',
        thumbnail:
    ...
    },
    {
        ...
        videoUrl: 'https://player.vimeo.com/video/285086929?background=1&autoplay=1&loop=1&muted=1',
        thumbnail:
    ...
    },
    {
        ...
        videoUrl: 'https://player.vimeo.com/video/434045692?background=1&autoplay=1&loop=1&muted=1',
        thumbnail:
            'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600',
...
export default function OurFarm() {
    ...
    const prevVideo = () => {
        setCurrentVideo((prev) => (prev - 1 + farmVideos.length) % farmVideos.length);
        setIsAutoPlaying(false);
        setIsPlaying(false);
    };
    ...
    return (
        <section className="py-16 md:py-16 bg-gradient-to-br from-viet-earth-cream via-white to-viet-green-light/20 relative overflow-hidden">
